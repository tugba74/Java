...
public class C03_LinkedListSoru {
    ...
    Soru : Bir ogretmenden ogrencilerin notlarini girmesini isteyin, not grime islemi
     bittiginde Q’ya basmalidir. Not grime islemi bittikten sonra asagidaki sekilde output hazirlayin
 not ortalamasi : …..
 ogrenci sayisi : …..
        ...
        while(loopDevam){
            try {
                ...
                if(girilendeger.equalsIgnoreCase("Q")){
                    ...
                    System.out.println("Not icin sayisal degerler girmelisin");
                }
