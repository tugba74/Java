...
public class C01_EntrySet {
    public static void main(String[] args) {
        // ogrenci mapinde sıralı olarak
        //tum ogrencilerin
        //bolum,sınıf, sube, isim, soyisim, ve numaralari yazdırırn

        //onceki derste key(set) ve value(collection) degerlerini toplu olarak alabiliyorduk
